...
//            initialViewController = storyboard.instantiateViewController(withIdentifier: "UserListViewController")
            let userListViewController = storyboard.instantiateViewController(withIdentifier: "UserListViewController")
            initialViewController = UINavigationController(rootViewController: userListViewController)
        } else {
